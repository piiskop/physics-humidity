...
T_dew_FOR_COMPARISON_ON_MANUAL <- c(paste("\\qty{", GetTKelvinFromTCelsius(9), "}{\\kelvin} kuni \\qty{", GetTKelvinFromTCelsius(10), "}{\\kelvin}"), paste("\\qty{", GetTKelvinFromTCelsius(5), "}{\\kelvin} kuni \\qty{", GetTKelvinFromTCelsius(6), "}{\\kelvin}"), paste("\\qty{", GetTKelvinFromTCelsius(6), "}{\\kelvin} kuni \\qty{", GetTKelvinFromTCelsius(7), "}{\\kelvin}"))
