...
DATA_FRAME_OF_COMPARISON <- data.frame(
  ...
  # T_dew_FOR_COMPARISON_FROM_W,
  # T_dew_FOR_COMPARISON_FROM_ASHRAE,
  # T_dew_FOR_COMPARISON_FROM_FAO,
  # T_dew_FOR_COMPARISON_REGARDING_TO_PSYCHROMETER
)
...
print_table(
  ...
  footnote(number = c(
    "valem (ref:saturation-pressure-over-liquid-h2o)",
    "valem (ref:saturation-pressure-in-inbook)",
    "valem (ref:humidity-ratio-using-enthalpies)",
    "valem (ref:actual-vapor-pressure)",
    "valem (ref:psychrometric-coefficient-in-whipple)",
    "valem (ref:psychrometric-coefficient)",
    "valem (ref:psychrometric-coefficient-for-natural-ventilation)",
    "Katseliselt leidsin, et Pasco ilmajaamas kasutatakse tõenäoliselt Assmanni psühromeetri reeglistikku.",
    "valem (ref:partial-vapor-pressure-from-humidity-ratio)",
    "valem (ref:relative-humidity-as-ratio-of-pressure)",
    "valem (ref:dew-point-temperature)",
    "valem (ref:dew-point-temperature-inbook-with-psychrometer)"
  ))
