...
```{r label = "dry-bulb-thermometer", fig.cap = "Assmann-psühhomeetri kuiv-kolv-termomeetri näit.", out.width="\\textwidth - 22.81554pt"}
include_svg("IMG_20220414_105513.jpg")
```

```{r label = "wet-bulb-thermometer", fig.cap = "Assmann-psühhomeetri märg-kolv-termomeetri näit."}
...
Kastepunkti katseliseks määramiseks kasutasime läikiva metalse välispinnaga kerajast kaussi, millesse sisestasime vee ja hakkasime seda jääga jahutama, kuni välisküljele tekkisid tilgad, mille puhul oli saavutatud kastepunkti temperatuur.
