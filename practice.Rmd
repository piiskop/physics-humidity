...
```{r label = "wet-dry-psychrometer", fig.cap = "Märg-kuiv-psühromeeter ((ref:psychrometer)).", fig.margin = TRUE, dpi=1200}
...
```{r label = "aspiration-psychrometer", fig.cap = "Aspiratsioonpsühromeeter ((ref:aspiration)).", fig.margin = TRUE}
