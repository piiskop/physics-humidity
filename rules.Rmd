...
composition_of_air <- adorn_totals(dat = composition_of_air, name = "Kokku", where = "row", fill = "", na.rm = TRUE, c(3, 4))
M_air_2008 <- 28.965369e-3
M_air <- composition_of_air[nrow(composition_of_air), 4] * 1e-6
delta_M_air <- (M_air - M_air_2008)

print_table(
  data_frame = composition_of_air,
