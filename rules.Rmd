...
```{=tex}
\begin{align}
T_\text{dp} :&= (6.54 + 14.526 \times ln(\frac{p_\text{w}}{\unit{\pascal}}) + .7389 \times (ln(\frac{p_\text{w}}{\unit{\pascal}}))^2 + .09486 \times (ln(\frac{p_\text{w}}{\unit{\pascal}}))^3\\
&+ .4569 \times p_\text{w}^{.1984} + 273.15) \cdot \unit{\kelvin}
