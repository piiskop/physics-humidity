...
\begin{align}
& p_\text{ws} && := e^{\sum_{i := 8}^{n}{C_i \times T^{i - 9}} + 6.5459673 \times \mathrm{ln}(T)}\\
...
millest johtuvalt on ühik $\unit{\kilogram\per\meter\per\second\squared\per\kelvin}$ ehk lühemalt $\unit{\pascal\per\kelvin}$.
